...
def test_build_context_header_appends_single_file_hint() -> None:
    parsed = ParsedMessage(
        ...
        pending_files=[
            SavedFileAttachment(
                name="foo.pdf",
                saved_path="/suzu/mods/qq-file-ingress/workspace/inbox/foo.pdf",
    ...
    assert (
        ...
        "/suzu/mods/qq-file-ingress/workspace/inbox/foo.pdf]" in header
    )
...
def test_build_context_header_appends_multi_file_hint() -> None:
    parsed = ParsedMessage(
        ...
        pending_files=[
            ...
            SavedFileAttachment(
                name="bar.csv",
                saved_path="/suzu/mods/qq-file-ingress/workspace/inbox/bar.csv",
    ...
    assert "- /suzu/mods/qq-file-ingress/workspace/inbox/foo.pdf" in header
    assert "- /suzu/mods/qq-file-ingress/workspace/inbox/bar.csv]" in header
